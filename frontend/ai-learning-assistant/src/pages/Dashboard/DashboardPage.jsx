...
const DashboardPage = () => {
  ...
  <div className="min-h-screen">
    ...
    <div className="relative max-w-7xl mx-auto px-6 py-10">
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className={`w-11 h-11 rounded-xl bg-linear-to-br ${stat.gradient} shadow-lg ${stat.shadowColor} flex items-center justify-center group-hover:scale-110 transition duration-300`}>
      ...
      <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/60 p-6">
            ...
            {[
              ...
              .map((activity, index) => (
                <div
                  ...
                  className="flex items-start justify-between p-4 rounded-xl border border-slate-200/60 bg-white hover:bg-slate-50 transition"
                >
